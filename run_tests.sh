...
echo "Code 7 start~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
node ./microgear_helpers/helper.js 22 &
sleep 3
node_modules/mocha/bin/mocha -g 'Code 7: Case 1' specs --require specs/helpers/chai.js
sleep 3
killall node
sleep 3

node ./microgear_helpers/helper.js 15 &
node_modules/mocha/bin/mocha -g 'Code 7: Case 2' specs --require specs/helpers/chai.js
sleep 3
killall node
sleep 3

node ./microgear_helpers/helper.js 4 &
node_modules/mocha/bin/mocha -g 'Code 7: Case 3' specs --require specs/helpers/chai.js
sleep 3
killall node
sleep 3

node ./microgear_helpers/helper.js 20 &
node_modules/mocha/bin/mocha -g 'Code 7: Case 4' specs --require specs/helpers/chai.js
sleep 3
killall node
sleep 3

node ./microgear_helpers/helper.js 21 &
sleep 3
node_modules/mocha/bin/mocha -g 'Code 7: Case 5' specs --require specs/helpers/chai.js
sleep 3
killall node
sleep 3
echo "Code 7 done~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
...
echo "Code 8 start~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
node_modules/mocha/bin/mocha -g 'Code 8: Case 1' specs --require specs/helpers/chai.js
sleep 3
node_modules/mocha/bin/mocha -g 'Code 8: Case 2' specs --require specs/helpers/chai.js
sleep 3
node_modules/mocha/bin/mocha -g 'Code 8: Case 3' specs --require specs/helpers/chai.js
sleep 3
node_modules/mocha/bin/mocha -g 'Code 8: Case 4' specs --require specs/helpers/chai.js
sleep 3
node ./microgear_helpers/helper.js 10 &
sleep 3
node_modules/mocha/bin/mocha -g 'Code 8: Case 5' specs --require specs/helpers/chai.js
sleep 3
killall node
sleep 3
...
node ./microgear_helpers/helper.js 10 &
sleep 3
node_modules/mocha/bin/mocha -g 'Code 8: Case 6' specs --require specs/helpers/chai.js
sleep 3
killall node
sleep 3
...
node ./microgear_helpers/helper.js 4 &
sleep 3
node_modules/mocha/bin/mocha -g 'Code 8: Case 7' specs --require specs/helpers/chai.js
sleep 3
killall node
sleep 3
echo "Code 8 done~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
